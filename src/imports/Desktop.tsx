import svgPaths from "./svg-kkj6a6odoq";
  ...
  return (
    <nav className="content-stretch flex font-['Instrument_Sans:SemiBold',sans-serif] font-semibold gap-[32px] items-center leading-[0] p-0 relative shrink-0 text-[20px] text-center text-nowrap text-white tracking-[-1px]" data-name="Nav">
      <div className="flex flex-col justify-center relative shrink-0" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-none text-nowrap whitespace-pre">Work</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-none text-nowrap whitespace-pre">Resume</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-none text-nowrap whitespace-pre">Contact</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-none text-nowrap whitespace-pre">Hire me</p>
      </div>
    </nav>
  );
}
...
function Header() {
  return (
    <header className="bg-[rgba(0,0,0,0.71)] relative shrink-0 w-full" data-name="Header 1">
...
function LogoPrimary1() {
  return (
    <div className="absolute bottom-[50px] h-[937px] right-[-105.4px] w-[1012.274px]" data-name="Logo/Primary">
...
function Frame1() {
  return (
    <div className="bg-gradient-to-b content-stretch flex flex-col from-[rgba(49,49,49,0)] h-[702px] items-center px-0 py-[55px] relative shrink-0 to-[#000000] w-full">
      <p className="font-['ED_Manteca:Regular',sans-serif] leading-[1.1] min-w-full not-italic relative shrink-0 text-[134px] text-center text-white tracking-[-6.7px] uppercase w-[min-content]">DESIGN SYSTEM ARCHITECT</p>
      <FooterText />
    </div>
  );
}
...
function Intro() {
  return (
    <div className="content-stretch flex items-start max-w-[633px] relative shrink-0" data-name="Intro">
      <p className="basis-0 font-['Instrument_Sans:Medium',sans-serif] font-medium grow leading-none min-h-px min-w-px relative shrink-0 text-[24px] text-black tracking-[-0.12px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Stat() {
  return (
    <div className="content-stretch flex flex-col gap-[17px] items-start relative shrink-0 text-black w-full" data-name="Stat 1">
...
function Stat1() {
  return (
    <div className="content-stretch flex flex-col gap-[17px] items-start relative shrink-0 text-black w-full" data-name="Stat 2">
      <p className="font-['Instrument_Sans:Regular',sans-serif] font-normal leading-[1.1] relative shrink-0 text-[142px] tracking-[-7.1px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        50+
      </p>
      <p className="font-['Instrument_Sans:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[20px] tracking-[-0.6px] uppercase w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Stat2() {
  return (
    <div className="content-stretch flex flex-col gap-[17px] items-start relative shrink-0 text-black w-full" data-name="Stat 3">
      <p className="font-['Instrument_Sans:Regular',sans-serif] font-normal leading-[1.1] relative shrink-0 text-[142px] tracking-[-7.1px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        850+
      </p>
      <p className="font-['Instrument_Sans:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[20px] tracking-[-0.6px] uppercase w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Stats() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-[432px]" data-name="Stats">
      <Stat />
      <div className="h-0 relative shrink-0 w-[432px]" data-name="Divider">
...
function TextLink() {
  return (
    <div className="content-stretch flex font-['Instrument_Sans:Medium',sans-serif] font-medium gap-[3px] items-center leading-[1.1] relative shrink-0 text-[#767676] text-[16px] text-nowrap tracking-[-0.48px] whitespace-pre" data-name="Text link">
...
function StatsContain() {
  return (
    <div className="content-stretch flex flex-col gap-[73px] items-start max-w-[642px] relative shrink-0 w-[432px]" data-name="Stats contain">
      <Stats />
      <TextLink />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Stats content">
      <div className="size-full">
        <div className="content-stretch flex flex-col gap-[108px] items-start px-[63.8px] py-0 relative w-full">
          <Frame />
          <StatsContain />
        </div>
      </div>
...
export default function Desktop() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Desktop">
      <div aria-hidden="true" className="absolute h-[835px] left-0 top-0 w-[1280px]" data-name="20250416_1923_Mesmerizing Black Sphere_simple_compose_01js0ry4wzepdrmn7zhfwqc9h5 1" role="presentation">
        <video aria-hidden="true" autoPlay className="absolute max-w-none object-cover size-full" controlsList="nodownload" loop playsInline role="presentation">
